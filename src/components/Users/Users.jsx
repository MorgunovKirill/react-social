                ...
                props.users.map(user => (
                        <div className={classes.user} key={user.id}>
                            <div className={classes.left}>
                                <img src="https://c0.klipartz.com/pngpicture/7/618/gratis-png-ilustracion-de-hombre-icono-de-avatar-avatar-de-moda-hombre.png" alt="avatar" width="100" height="100" />
